# main.py or app.py both are same
import os
...
# command for executing the fast api : cmd to api folder where you have this main.py file and run below command 
# uvicord - application server interface
