...
class SingleDocIngestor:
    def __init__(self,data_dir:str="data/single_document_chat",fiass_dir:str="fiass_index"):
        try:
            ...
            self.log.info("SingleDocIngestor initialized",temp_path=str(self.data_dir),fiass_path=str(self.faiss_dir))

        except Exception as e:
            self.log.error("Failed to initialize SingkeDocIngestor",error=str(e))
